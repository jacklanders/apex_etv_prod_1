...
const notepad2Tab2 = document.getElementById("notepad2.Tab2");
  if (notepad2Tab2) {
   ...
   function autoAjustar(textarea) {
    ...
    extarea.style.height = (textarea.scrollHeight) + 'px';
    }
   
  notepad2Tab2.style.display = "block";
  const botonLimpiarTab2 = document.getElementById("botonLimpiarTab2");
   
  if (botonLimpiarTab2) {
    botonLimpiarTab2.addEventListener("click", function() {
